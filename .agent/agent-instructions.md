# AION-Transporter — Agent instructions
...
- Explain each step in a clear, concise way.
- Describe the exact code change before writing code.
- Ask for confirmation before applying a code change when interactive approval is needed.
...
- Certificates: Use openssl x509 -in cert.pem -text to inspect generated certs# AION-Transporter — Agent instructions
...
- QUIC connections: Check CERT_PATH/KEY_PATH environment variables
- Multicast: Verify UDP port 9999 is not blocked by firewall
- Certificates: Use openssl x509 -in cert.pem -text to inspect generated certs